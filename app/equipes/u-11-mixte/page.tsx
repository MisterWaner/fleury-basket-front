...
export default function Page() {
    return (
        <>
            ...
            <Wrapper>
                <p>
                    Pour cette saison 2025/2026, notre équipe U-11 Mixte évolue
                    en championnat Départemental (Poule B) du Calvados.
                </p>
                    ...
                    <Tabs defaultValue="phase 1" >
                        ...
                        <TabsContent value="phase 1">
                            <Card >
                                <CardHeader>
                                    <CardTitle>
                                        Calendrier U-11 Mixte - Phase 1
                                    </CardTitle>
                                </CardHeader>
                                <CardContent>
                                    <CalendarTable team="u-11-mixte" phase="phase-1" />
                                </CardContent>
                            </Card>
                        </TabsContent>
                        <TabsContent value="phase 2">
                            <Card>
                                <CardHeader>
                                    <CardTitle>
                                        Calendrier U-11 Mixte - Phase 2
                                    </CardTitle>
                                </CardHeader>
                                <CardContent>
                                    <CalendarTable team="u-11-mixte" phase="phase-2" />
                                </CardContent>
                            </Card>
                        </TabsContent>
                    </Tabs>
                    ...
                    <Tabs defaultValue="phase 1">
                        ...
                        <TabsContent value="phase 1">
                            <Card>
                                <CardHeader>
                                    <CardTitle>
                                        Classement U-11 Mixte - Phase 1
                                    </CardTitle>
                                </CardHeader>
                                <CardContent>
                                    <RankingTable team="u-11-mixte" phase="phase-1" />
                                </CardContent>
                            </Card>
                        </TabsContent>
                        <TabsContent value="phase 2">
                            <Card>
                                <CardHeader>
                                    <CardTitle>
                                        Classement U-11 Mixte - Phase 2
                                    </CardTitle>
                                </CardHeader>
                                <CardContent>
                                    <RankingTable team="u-11-mixte" phase="phase-2" />
                                </CardContent>
                            </Card>
                        </TabsContent>
                    </Tabs>
